...
scenarios <- read.csv("scenarios_ext.csv")
...
res <- NULL
for(i in 1:N){
  x <- generate_data(m, int_t, target_n, beta_m, beta_s, v_sh, v_r, setup_r_a, setup_r_b, m_p=m_p, target_n_p=target_n_p, internal=FALSE)
